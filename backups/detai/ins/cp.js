...
export default function corp() {
    ...
    const [form, setForm] = useState({
        insuranceType: "", insuredName: "", insuredAddress: "", businessNature: "", pincode: "", riskLocation: "", contactName: "", contactMobile: "", contactEmail: "", policyType: "", coverType: 'individual', maternityCover: false, preExistingDisease: false, roomRentLimit: "", sumInsured: "", claimLastYear: ""
        , medicalExtension: "no", medicalLimit: "",
        wcRows: [
    ...
    const handleSubmit = async () => {
        if (!validate()) {
            Alert.alert("Error", "Please fill all requird fields correctlt");
            return;
        }
        ...
        try {
            const payload = {
                ...
                product_type: "Corporate Insuarnce",
                sub_category: "Corporate In surance",
                client: {
                ...
                form_data: {
                    ...
                    riskLocationL: form.riskLocation,
            ...
            if (!leadId) throw new Error("Lead ID is missing in response");
            // upload  documents
