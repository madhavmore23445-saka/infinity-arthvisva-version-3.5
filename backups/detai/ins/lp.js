...
export default function loan() {
    ...
    const [form, setForm] = useState({
        name: "",
        dob: "", loanAmount: "", pincode: "", loanAccountNumber: "", loanType: "", loanTenure: ""
    });
    ...
    const validate = () => {
        ...
        req("loanType", "Select Loan Type");
        req("loanTenure", "Select Tenure");
    ...
    const handleSubmit = async () => {
        if (!validate()) {
            Alert.alert("Error", "Plese fill all the requird fileds");
            return;
        }
        ...
        try {
            ...
            Toast.show({
                type: "success",
                text1: "Application Submitted"m,
                text2: "LOan Protector application submitted",
                position: "top",
                visibilityTime: 1800,
                autoHide: true,
                topOffset: 20,
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.card}>
                    ...
                    <InputGroup label="Full Name" required value={form.name} onChange={v => handleInputChange("name", v)} error={errors.name} placeholder="Enter full name" />
                    ...
                    <InputGroup label="Pincode" required value={form.pincode} onChange={v => handleInputChange("pincode", v)} error={errors.pincode} keyboardType="numeric" maxLength={6} placeholder="6-digit pincode" />
                ...
                <View style={styles.card}>
                    ...
                    <InputGroup label="Loan Amount" required value={form.loanAmount} onChange={v => handleInputChange("loanAmount", v)} error={errors.loanAmount} keyboardType="numeric" placeholder="Outstanding amount" />
                    <InputGroup label="Loan Account Number" required value={form.loanAccountNumber} onChange={v => handleInputChange("loanAccountNumber", v)} error={errors.loanAccountNumber} placeholder="Bank account number" />
                    ...
                    <CustomPicker
                        ...
                        value={form.loanType}
                        options={LOAN_TYPES}
                        onSelect={v => handleInputChange("loanType", v)}
                    ...
                    <CustomPicker
                        ...
                        onSelect={v => handleInputChange("loanTenure", v)}
...
export default function LoanProtectorFormScreen() {
