...
export default function Health() {
    ...
    const [form, setForm] = useState({
        policyType: "", planType: "", proposer: "", mobile: "", email: "", city: "", pin: "", PSA: "", policyTenure: "", dob: "", disease: "", FirstAdultDob: "", SecondAdultDob: "", child1Dob: "", child2Dob: "",
    });
    const [errors, setErrors] = useState({});

    // document state

    const [prevPolicyDocs, setPrevPolicyDocs] = useState([]);
    ...
    const pickDocument = async () => {
        try {
            ...
            const result = await DocumentPicker.getDocumentAsync({
                ...
                multiple: true // allow multiple if possible or signal sequential
            });
         ...
         try {
            ...
            for(const file of prevPolicyDocs){
                ...
                const  fileObj = {
                    uri:file.uri,
                    name:file.name,
                    type:file.mimeType || "application/octet - strem"
                };
