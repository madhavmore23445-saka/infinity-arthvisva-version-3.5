...
export default function Marine() {
    ...
    const [form, setForm] = useState({
        proposer: "", policyNo: "", address: "", business: "", insurancePeriod: "", subjectMatter: "", packing: "", transitFrom: '', transitTo: "", transitMode: "", valuation: "", sumAssured: "", bottomLimit: "", locationLimit: ""
    });
    ...
    const handleSubmit = async () => {
        if(!validate()){
            Alert.alert("Error" , "Please fill all required fileds correctly");
            return
        }
